...
<body>
    ...
    <div class="comprehension-screen" id="comprehensionScreen">
        <div class="comprehension-box">
            ...
            <div class="comprehension-question">
                <label>6. During the brainstorming task, using Generative AI (through "ChatGPT Assistant" section of the interface) is allowed.</label>
                <div class="radio-group">
                    <div class="radio-option">
    ...
    <script>
        ...
        const hints = {
            ...
            q6: 'You are allowed to use Generative AI for this brainstorming task.',
