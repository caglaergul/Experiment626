...
<body>
    ...
    <div class="comprehension-screen" id="comprehensionScreen">
        <div class="comprehension-box">
            ...
            <div class="comprehension-question">
                <label>4. You must ensure that the entry you submit is the final version of your idea.</label>
                <div class="radio-group">
                    <div class="radio-option">
            ...
            <div class="comprehension-question">
                <label>5. You can edit the final idea after you submit it.</label>
                <div class="radio-group">
                    <div class="radio-option">
