...
<body>
    ...
    <div class="comprehension-screen" id="comprehensionScreen">
        <div class="comprehension-box">
            ...
            <div class="comprehension-question">
                <label>4. Both my team member and I must approve the final idea we agree on before submitting it.</label>
                <div class="radio-group">
                    <div class="radio-option">
            ...
            <div class="comprehension-question">
                <label>5. I can edit the final idea after my team member approves it.</label>
                <div class="radio-group">
                    <div class="radio-option">
            ...
            <div class="comprehension-question">
                <label>6. Using Generative AI during brainstorming through the ChatGPT Chat section is highly encouraged.</label>
                <div class="radio-group">
                    <div class="radio-option">
    ...
    <div class="survey-screen" id="strategyPage">
        <div class="survey-box">
            <h2>Please describe the strategies you used to complete the brainstorming task.</h2>
